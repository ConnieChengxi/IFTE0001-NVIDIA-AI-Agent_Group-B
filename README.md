...
└── outputs/
    └── trade_note.md       # LLM-generated narrative summary (optional)
...
run the backtest
print performance metrics to the terminal and generate a technical trade note
