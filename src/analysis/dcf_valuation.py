"""
Discounted Cash Flow (DCF) valuation with multi-stage growth models.
"""
...
from src.utils.helpers import get_latest, get_historical
...
class DCFValuator:
    ...
    def _calculate_stage1_growth_rate(self) -> float:
        ...
        min_growth = self.params.get('min_stage1_growth', self.params.get('terminal_growth', TERMINAL_GROWTH_RATE))
        final_growth = max(final_growth, min_growth)
