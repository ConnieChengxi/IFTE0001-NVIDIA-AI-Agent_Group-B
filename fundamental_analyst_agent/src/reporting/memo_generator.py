...
Write ONLY the description. No preamble."""
    ...
    def _page4_valuation(self) -> str:
        ...
        html += f'''
            <p><strong>DCF Methodology ({company_type} Company) - 3-STAGE MODEL:</strong></p>
            <ul style="line-height: 1.8;">
                ...
                <li><strong>WACC:</strong> {self._pct(wacc)} (Beta: {beta:.2f}, Risk-Free: {self._pct(risk_free)}, ERP: {self._pct(erp)})</li>
            </ul>
