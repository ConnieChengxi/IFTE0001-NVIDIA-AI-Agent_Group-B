"""
Configuration settings for the Fundamental Analyst Agent.
"""
...
CACHE_TTL_HOURS = 24  # Default for market data (OVERVIEW, GLOBAL_QUOTE)
CACHE_TTL_STATEMENTS_DAYS = 90  # For financial statements (quarterly data)

# Data types that should use extended TTL
STATEMENT_FUNCTIONS = ['INCOME_STATEMENT', 'BALANCE_SHEET', 'CASH_FLOW']
...
INDUSTRY_PEERS = {
    "semiconductors": [
        "NVDA", "AMD", "INTC", "QCOM", "AVGO", "TXN", "MRVL",
        "ADI", "NXPI", "ON", "SWKS", "MCHP", "MPWR"
    ],
    "memory chips": [
        "MU", "WDC", "STX"
    ],
    "semiconductor equipment": [
        "ASML", "LRCX", "KLAC", "AMAT", "TER", "ENTG", "MKSI", "ACLS"
    ],
...
RELATED_INDUSTRIES = {
    "semiconductors": ["semiconductor equipment", "software - infrastructure", "communication equipment"],
    "semiconductor equipment": ["semiconductors", "industrial machinery", "electronic components"],
    ...
    "consumer electronics": ["semiconductors", "communication equipment", "software - infrastructure", "internet content & information"],
